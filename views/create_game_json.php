...
<head>
    ...
    <script src="../scripts/create_game_json.js" type="module" defer></script>
    ...
    <link rel="stylesheet" href="./styles/create_game_json.css">
...
<style>
  ...
  @import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400&display=swap');
    ...
    <main id="create-level-json">
        <h2>Стъпки за създаване на игра с JSON конфигурация:</h2>
        <ol>
            ...
            <li>Създай игра.</li>
            <button class="generic-button" id="upload-button" type="submit"><span>СЪЗДАЙ ИГРА</span></button>
        </ol>
